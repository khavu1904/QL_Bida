...
namespace QUANLIBIDA
{
    public partial class FrmMatHang : Form
    {
        ...
        private void frmMatHang_Load(object sender, EventArgs e)
        {
            ...
            db = new BIDA_DatabaseDataContext();//khởi tạo đối tượng db 

            cbbMatHangGoc.DataSource = db.MatHangs.Where(x => (x.IDCha ==null || x.IDCha == -1) &&  x.isDeleted == 0); //id cha bằng null hoặc -1 tức là không có mặt hàng nào là cha
            ...
            cbbDVT.DataSource = db.DonViTinhs.Where(x => x.isDeleted == 0);
            ...
            //focus chuột ở textbox đầu tiên, đỡ click chuột
            txtTenMatHang.Select();
        }

        private void ShowData()
        {
            var rs = from h in db.MatHangs.Where(x => x.isDeleted ==0)
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            //ràng buộc dữ liệu
            //nếu không có hàng nào được chọn thì yêu cầu chọn hàng cần cập nhật
            if (r == null)
            {
