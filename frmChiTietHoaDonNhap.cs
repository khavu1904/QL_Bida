...
namespace QUANLIBIDA
{
    ...
    {
        public frmChiTietHoaDonNhap(int idHoaDon, byte danhapkho)//tham số này được truyền qua để lấy mã hóa đơn nhập
        {
        ...
        private int idHoaDon;//khai báo 1 biến để lấy mã hóa đơn được truyền qua
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (item==null)//nếu chưa có trong đơn nhập hàng
            {
                ...
                ct.DonGia = int.Parse(txtDonGiaNhap.Text);
